...
const newNumArr = numbers.map((element) => {
    return element * 1;
});
console.log(newNumArr); //Test
...
const newFloatNumArr = floatNumbers.map((element) => {
    return element * 1;
});
console.log(newFloatNumArr); //Test
...
const namesArr = movies.map((element) => {
    return element.name;
});

//console.log(namesArr); //Test
...
const objArr = movies.map((element) => {
    let resObj = {};
    resObj.name = element.name;
    resObj.genre = element.genres;
    return resObj;
});
